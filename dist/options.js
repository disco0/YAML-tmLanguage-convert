...
//#endregion Imports
const optionParser = yargs_1.default(process.argv.slice(2))
    .options({
    trace: {
        boolean: true,
...
exports.options = ((poorlyTyped) => poorlyTyped)(optionParser.argv);
// Push in remaining args, if needed
if (exports.options._.length > 0) {
    if (exports.options._.indexOf('--') !== -1) {
        exports.options['input-file'].push(...exports.options._.slice(exports.options._.indexOf('--')));
        exports.options._.length = exports.options._.indexOf('--') - 1;
    }
    else {
        exports.options['input-file'].push(...exports.options._.slice(exports.options._.indexOf('--')));
        exports.options._.length = 0;
    }
}
// Exit with help if no input files (not done in main chain due to above shifting of args)
if (!(exports.options['input-file'].length > 0)) {
